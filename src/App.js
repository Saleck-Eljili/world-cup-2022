...
function App() {
  ...
  const getRandomInt = () => {
    ...
    if (ran === 1) {
      ...
      setVariant2("Danger");
      setShow(true);
      setCongrat("Félicitations! cameroun");
    }
    if (ran === 2) {
      setVariant2("Success");
      setVariant("Danger");
      setShow(true);
      setCongrat("Félicitations! serbie");
    }
    if (ran === 0) {
      setVariant2("Light");
      setVariant("Light");
    ...
    if (ran3 === 1) {
      ...
      setVariant6("Danger");
      setShow3(true);
      setCongrat3("Félicitations! brésil");
    }
    if (ran3 === 2) {
      setVariant6("Success");
      setVariant5("Danger");
    ...
    if (ran4 === 1) {
      ...
      setVariant8("Danger");
      setShow4(true);
      setCongrat4("Félicitations! portugal");
    }
    if (ran4 === 2) {
      setVariant8("Success");
      setVariant7("Danger");
      setShow4(true);
      setCongrat4("Félicitations! uruguay");
    }
    if (ran4 === 0) {
      setVariant8("Light");
      setVariant7("Light");
